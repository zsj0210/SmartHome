...
#define PROID			"1c6LfBoi8J"

#define ACCESS_KEY		"Mm1QdkJtU01XbFFaRXp2UnVUU1Z5YTh3V3JSeWhmbkE="
...
_Bool OneNet_DevLink(void)
{
	...
	OneNET_Authorization("2018-10-31", PROID, 2073193331, ACCESS_KEY, DEVICE_NAME,
